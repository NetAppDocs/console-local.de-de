...
Alle Rollen außer Federation admin und Federation viewer. Benutzer mit der Rolle Federation admin oder Federation viewer können keine Warnmeldungen anzeigen. link:reference-iam-predefined-roles.html["Informationen zu Zugriffsrollen"].
