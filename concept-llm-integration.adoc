...
summary: Die Integration der lokalen NetApp Console Bereitstellung mit OpenAI und OpenAI-kompatiblen Modellen, einschließlich Anbieter-, Proxy- und Sicherheitsentscheidungen, wird erläutert. 
---
