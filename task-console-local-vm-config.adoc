...
summary: Nach der Bereitstellung der Console local deployment können Änderungen an Ihrem bestehenden VCenter- oder ESXi-Host vorgenommen werden. 
---
...
[role="lead"]
In der lokalen NetApp Console-Bereitstellung können nach der Bereitstellung Änderungen an Ihrem bestehenden VCenter- oder ESXi-Host vorgenommen werden.
