...
Eine detaillierte Übersicht über die Hierarchie und das Zugriffsmodell befindet sich unter link:concept-folders-fleets-overview.html["Informationen zu Ordnern und Flotten in der lokalen Bereitstellung der NetApp Console"].
...
* Informationen zu Speicherstandards sind unter link:concept-storage-classes.html["Informationen zu Speicherklassen und Richtlinien in der lokalen Bereitstellung der NetApp Console"] verfügbar.
* Informationen zum Erstellen und Verwalten von Flotten sind unter link:task-iam-manage-folders-fleets.html["Ordner und Flotten verwalten"] verfügbar.
