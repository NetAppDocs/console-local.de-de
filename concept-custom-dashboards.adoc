...
Einen vollständigen Katalog der vordefinierten Karten und Metriken enthält link:reference-dashboard-card-templates.html["Informationen zu benutzerdefinierten Dashboard-Karten und Metriken in der lokalen NetApp Console-Bereitstellung"].
