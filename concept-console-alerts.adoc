...
Die lokale Bereitstellung über die Konsole bündelt Warnmeldungen von ONTAP Clustern sowie von Backup und Recovery Vorgängen in einer einzigen Ansicht. Die Seite „Warnmeldungen“ umfasst ein Dashboard, eine Warnmeldungs­liste und eine Ansicht, die Warnmeldungen aller Systeme in der Organisation anzeigt. Jede Warnmeldung identifiziert das betroffene System, den Schweregrad und den Auswirkungsbereich.
...
* *Schweregrad* gibt die Dringlichkeit an, von höchster zu niedrigster: Kritisch, Warnung und Information.
* *Auswirkungsbereich* kennzeichnet die betroffene Domäne: Verfügbarkeit, Kapazität, Konfiguration, Leistung, Schutz und Sicherheit.
...
* *ONTAP-Warnungen* stammen aus dem ONTAP Event Management System (EMS) auf den lokalen Clustern, die von der lokalen Console-Bereitstellung erkannt wurden, sowie aus Überwachungsmetriken, die von ONTAP erfasst werden. link:https://docs.netapp.com/us-en/ontap-ems/acp-auto-events.html["Weitere Informationen zu ONTAP EMS und den verfügbaren Warnmeldungen."^]
...
* Es gilt für alle Systeme in der Organisation.
...
* link:task-alert-rules-manage.html["Benachrichtigungsregeln erstellen und verwalten"]
