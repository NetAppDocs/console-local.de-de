...
summary: Bevor ein Supportfall beim NetApp Technical Support eröffnet werden kann, muss ein NetApp Support Site-Konto zur NetApp Console lokalen Bereitstellung hinzugefügt und anschließend eine Registrierung für den Support vorgenommen werden. 
---
