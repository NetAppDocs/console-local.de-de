...
| LLM-Integration konfigurieren und den Console Assistent aktivieren | Ja | Nein 


| Einstellungen für die Benachrichtigungszustellung und den E-Mail-Server konfigurieren | Ja | Nein 
|===
