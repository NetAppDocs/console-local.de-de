...
Weitere Informationen zur Organisation von Flotten finden Sie unter link:concept-manage-storage.html["Informationen zum Flottenmanagement in der lokalen NetApp Console-Bereitstellung"].
...
* Informationen zur Organisation der Flotte finden Sie unter link:concept-manage-storage.html["Informationen zum Flottenmanagement in der lokalen NetApp Console-Bereitstellung"].
* Informationen zum Erstellen von Richtlinien und Speicherklassen sind unter link:task-storage-class-manage.html["Speicherklassen und Richtlinien verwalten"] zu finden.
...
* Zur Analyse und Behebung von Drift siehe link:task-storage-class-drift-remediate.html["Speicherklassenabweichung beheben"]
