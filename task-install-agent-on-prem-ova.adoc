...
summary: Wenn Sie VMware-Nutzer sind, kann eine OVA verwendet werden, um einen Console-Agenten in Ihrem vCenter zu installieren. Der OVA-Download oder die URL ist über die lokale NetApp Console-Bereitstellung verfügbar. 
---
